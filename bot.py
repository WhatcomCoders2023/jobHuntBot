...
class JobHuntingBot(commands.Bot):
    def __init__(self, filename: str, channel_id: int, parse_flag: int, command_prefix="!", intents=discord.Intents.all()):
    ...
    async def setup_hook(self):
        # Load your cogs here
        await self.add_cog(JobHuntingCog(self, self.filename, self.channel_id, self.parse_flag))
